...
class ReactionRateConstants(LearnableParameter):
    ...
    def save_chrom2checkpoint(self, iteration, initial_iteration=0, output_name="Optimization"):
        data1 = pd.DataFrame(self.chrom)
...
class ReductionCode(LearnableParameter):
    ...
    def __init__(self, root_path, n_species, mutation_rate, population, initial_population, remained_species_encode_through_sensitivity=None):
